...
(function (global) {
  ...
  const ICONS = {
    ...
    mail: '<rect x="3.75" y="5.75" width="16.5" height="12.5" rx="2.75"/><path d="m4.5 7.5 7.5 5.75 7.5-5.75"/>',
    clock: '<circle cx="12" cy="12" r="8.25"/><path d="M12 7.75V12l3 2"/>',
    alert: '<path d="M10.3 4.6 3.4 16.9a2 2 0 0 0 1.7 3h13.8a2 2 0 0 0 1.7-3L13.7 4.6a2 2 0 0 0-3.4 0z"/><path d="M12 9.75v4M12 16.75v.01"/>',
    ...
    timer: '<circle cx="12" cy="13.25" r="7"/><path d="M12 9.75v3.5l2.25 1.5M9.75 3.75h4.5M12 3.75v2.5"/>',
    route: '<circle cx="6.25" cy="17.75" r="2"/><circle cx="17.75" cy="5.75" r="2"/><path d="M8.25 17.75h7.25a3 3 0 0 0 0-6h-7a3 3 0 0 1 0-6h7.25"/>'
  };
